...
# runs your code
srun python classification.py  --experiment "overfit"  --device cuda --model "distilBERT-base-uncased" --batch_size "32" --lr 1e-4 --num_epochs 20 --small_subset True  # --small_subset True
